...
fmi2_sublist.customer.push({
  url: "https://closedbanks.fdic.gov/funds/index.asp",
  text: "Search for unclaimed insured deposits",
});
fmi2_sublist.customer.push({
  url: "https://ask.fdic.gov/FDICCustomerAssistanceForm",
...
function fmi2_click() {
  ...
  var action_string =
    location.href + "- find more info [" + user + ", " + user_action + "]";
  if (user !== "") {
