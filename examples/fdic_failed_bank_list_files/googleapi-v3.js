...
if (!window["google"]["loader"]) {
  ...
  (function() {
    ...
    function B(a) {
      return a in C
        ? C[a]
        : (C[a] = -1 != navigator.userAgent.toLowerCase().indexOf(a));
    }
    var C = {};
    function E(a, b) {
      var c = function() {};
    ...
    google.loader.fa = function(a) {
      if ((a = a.specs) && a.length)
        for (var b = 0; b < a.length; ++b) {
          ...
          "string" == typeof c
            ? (J[":" + c] = new Q(c))
            : ((c = new R(c.name, c.baseSpec, c.customSpecs)),
              (J[":" + c.name] = c));
        }
    };
    ...
    Q.prototype.j = function(a, b) {
      ...
      if (!this.u) {
        ...
        for (d in this.m)
          ":" == d.charAt(0) && this.m[d] && b.push(d.substring(1));
    ...
    Q.prototype.load = function(a, b) {
      ...
      for (var f = [], g = c.length - 1; 0 <= g; g--) {
        ...
        d && e.W(k);
        this.m[":" + k]
          ? (c.splice(g, 1), d && this.h[":" + k].push(e))
          : f.push(k);
      }
      if (c.length) {
    ...
    Q.prototype.s = function(a) {
      -1 != this.f &&
        (T("al_" + this.b, "jl." + (new Date().getTime() - this.f), !0),
        (this.f = -1));
    ...
    S.prototype.Z = function(a) {
      this.w[":" + a] &&
        ((this.w[":" + a] = !1),
        this.D--,
        0 == this.D && window.setTimeout(this.Y, 0));
    };
    function R(a, b, c) {
      this.name = a;
      this.X = b;
    ...
    var V = !1,
      ...
      T = function(a, b, c) {
        c
          ...
          : (Y(),
            W.push(
              "r" + W.length + "=" + encodeURIComponent(a + (b ? "|" + b : ""))
            ),
  ...
  google.loader.rfm({
    ":search": {
      ...
      properties: {
        ":Version": "1.0",
        ":NoOldNames": false,
        ":JSHash": "c0497eba726ac5bee594830508847206"
      }
    },
    ":language": {
      versions: { ":1": "1", ":1.0": "1" },
...
// 			"000294088679484612064:gnch0k3llsy", document.getElementById('query'), 'cse-search-box-form-id',
...
google.setOnLoadCallback(function() {
  if (document.getElementById("query2") !== null) {
    google.search.CustomSearchControl.attachAutoCompletionWithOptions(
      "000294088679484612064:gnch0k3llsy",
      document.getElementById("query2"),
      "cse-search-box-form-id2",
      autoCompletionOptions
    );
  }
});
